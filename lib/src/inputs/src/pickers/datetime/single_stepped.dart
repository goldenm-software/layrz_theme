...
class ThemedDateTimeSteppedPicker extends StatefulWidget {
  ...
  @override
  State<ThemedDateTimeSteppedPicker> createState() => _ThemedDateTimeSteppedPickerState();
}

class _ThemedDateTimeSteppedPickerState extends State<ThemedDateTimeSteppedPicker> {
  ...
  @override
  void didUpdateWidget(ThemedDateTimeSteppedPicker oldWidget) {
  ...
  TimeOfDay? get _selectedTime =>
      widget.value != null ? TimeOfDay(hour: widget.value!.hour, minute: widget.value!.minute) : null;
  ...
  void _showTimePicker() async {
    TimeOfDay? result = await showDialog(
      ...
      builder: (context) => _ThemedTimeUtility(
        ...
        inDialog: true,
        disableBlink: widget.disableTimePickerBlink,
      ),
    );
